...
<div class="container mt-3">
  <div class="row justify-content-md-center">
    ...
    $sqlEmpleados   = ("SELECT * FROM Clientes WHERE id_cliente='$idEmpleados' LIMIT 1");
    ...
    <div class="col-md-5 mb-3">
      ...
      <form method="POST" action="actionC.php?metodos=2" enctype="multipart/form-data">
      <input type="text" name="id_cliente" value="<?php echo $dataEmpleados['id_cliente']; ?>" hidden>
      <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" name="Telefono" class="form-control" value="<?php echo $dataEmpleados['Telefono']; ?>">
        </div>
        <div class="mb-3">
          <label for="formFile" class="form-label">Foto del cliente</label>
    ...
    <div class="col-md-5 mb-3">
        <label class="form-label">Foto actual de Cliente</label>
        <br>
